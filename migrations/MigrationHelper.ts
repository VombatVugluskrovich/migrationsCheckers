...
// export function ZZZ<T>((type?: any) => ObjectType<T>, inverseSide?: string | ((object: T) => any), options?: RelationOptions)): Function {
//   options.persistence = false;
//   return ManyToOne(typeFunctionOrTarget, inverseSide, options);
// }
